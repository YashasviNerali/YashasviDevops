...
import ${package}.screens.EditWorkScreen;
...
public class MainApplication extends Application
{
	...
	public static void main(String[] pArgs)
	{
		...
		System.setProperty(IPackageSetup.CONFIG_BASEDIR, new File(new File("../${artifactId}-war/").getAbsolutePath(), "/src/main/webapp/WEB-INF").getAbsolutePath());
